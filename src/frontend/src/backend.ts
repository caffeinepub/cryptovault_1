...
import type { CurrencySymbol as _CurrencySymbol, Time as _Time, Transaction as _Transaction, TransactionId as _TransactionId, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addTransaction(arg0: CurrencySymbol, arg1: Variant_receive_send, arg2: number, arg3: number, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addTransaction(arg0, to_candid_variant_n1(this._uploadFile, this._downloadFile, arg1), arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateBalance(arg0: CurrencySymbol, arg1: number): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_variant_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    send: null;
}): Variant_receive_send {
    return "receive" in value ? Variant_receive_send.receive : "send" in value ? Variant_receive_send.send : value;
}
...
function to_candid_variant_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Variant_receive_send): {
    receive: null;
} | {
    send: null;
} {
    return value == Variant_receive_send.receive ? {
        receive: null
    } : value == Variant_receive_send.send ? {
        send: null
    } : value;
}
